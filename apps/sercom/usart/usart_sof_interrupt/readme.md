...
| ----------------- | ---------------------------------------------- |
| pic32cm_le00_cpro.X <br> pic32cm_le00_cpro_NonSecure.X | Secure and Non-Secure MPLABX projects for MPLABX project for [PIC32CM LE00 Curiosity Pro Evaluation Kit]() |
|||
...
| Project Name| Board|
|:---------|:---------:|
| pic32cm_le00_cpro_Secure.X <br> pic32cm_le00_cpro_NonSecure.X | [PIC32CM LE00 Curiosity Pro Evaluation Kit]() |
|||
