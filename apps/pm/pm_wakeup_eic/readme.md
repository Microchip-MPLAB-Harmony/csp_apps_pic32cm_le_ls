...
7. Press the switch SW0 if 'a' or 'b' selected or press the switch RESET if 'c' selected to exit the low power mode
...
| ---------- | ----------- | ---------- |
| [PIC32CM LE00 Curiosity Pro Evaluation Kit](https://www.microchip.com/en-us/development-tool/EV80P12A) | SW0 and RESET | LED0 |
||||
