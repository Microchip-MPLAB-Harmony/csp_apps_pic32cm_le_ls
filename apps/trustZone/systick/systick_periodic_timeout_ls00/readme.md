...
| Type        | Path                         |
|:-----------:|:----------------------------:|
| Project group | apps/trustZone/systick/systick_periodic_timeout_ls00 |
|Secure Project|  apps/trustZone/systick/systick_periodic_timeout_ls00/Secure/firmware |
|Non-Secure Project|  apps/trustZone/systick/systick_periodic_timeout_ls00/NonSecure/firmware |
||||
