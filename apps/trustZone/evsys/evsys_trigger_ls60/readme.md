...
| Type        | Path                         |
|:-----------:|:----------------------------:|
| Project group | apps/trustZone/evsys/evsys_trigger_ls60 |
|Secure Project|  apps/trustZone/evsys/evsys_trigger_ls60/Secure/firmware |
|Non-Secure Project|  apps/trustZone/evsys/evsys_trigger_ls60/NonSecure/firmware |
||||
