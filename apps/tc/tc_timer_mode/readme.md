...
| ----------------- | ---------------------------------------------- |
| pic32cm_le00_curiosity_pro | MPLABX project for [PIC32CM LE00 Curiosity Pro Evaluation Kit]() |
|||
...
| Project Name| Board|
|:---------|:---------:|
| pic32cm_le00_curiosity_pro | [PIC32CM LE00 Curiosity Pro Evaluation Kit]()
|||
